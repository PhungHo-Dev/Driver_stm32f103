...
typedef struct {
	//CRL - Port configuration register low (offset 0x00, pin 0-7)
	union{
		uint32_t REG;
		struct{
			uint32_t MODE0 : 2;
	...
	//CRH - Port configuration register high (offset 0x04, pin 8-15)
	union{
		uint32_t REG;
		struct{
			uint32_t MODE8  : 2;
	...
	//IDR - Port input data register (offset 0x08)
	union{
		uint32_t REG;
		struct{
			uint32_t IDR0  : 1;
	...
	//ODR - Port output data register (offset 0x0C)
	union{
		uint32_t REG;
		struct{
			uint32_t ODR0  : 1;
	...
	//BSRR - Port bit set/reset register (offset 0x10, write-only)
	union{
		uint32_t REG;
		struct{
			uint32_t BS0  : 1;
	...
	//BRR - Port bit reset register (offset 0x14, write-only)
	union{
		uint32_t REG;
		struct{
			uint32_t BR0  : 1;
	...
	//LCKR - Port configuration lock register (offset 0x18)
	union{
		uint32_t REG;
		struct{
			uint32_t LCK0  : 1;
